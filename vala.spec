...
Source0  : https://download.gnome.org/sources/vala/0.56/vala-0.56.12.tar.xz
...
%prep
%setup -q -n vala-0.56.12
cd %{_builddir}/vala-0.56.12
pushd ..
cp -a vala-0.56.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692635660
