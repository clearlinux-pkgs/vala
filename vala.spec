...
Source0  : https://download.gnome.org/sources/vala/0.52/vala-0.52.0.tar.xz
...
%prep
%setup -q -n vala-0.52.0
cd %{_builddir}/vala-0.52.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616088500
...
cp %{_builddir}/vala-0.52.0/COPYING %{buildroot}/usr/share/package-licenses/vala/caeb68c46fa36651acf592771d09de7937926bb3
%make_install
