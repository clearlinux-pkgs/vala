...
Source0  : https://download.gnome.org/sources/vala/0.52/vala-0.52.3.tar.xz
...
%prep
%setup -q -n vala-0.52.3
cd %{_builddir}/vala-0.52.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620001984
...
cp %{_builddir}/vala-0.52.3/COPYING %{buildroot}/usr/share/package-licenses/vala/caeb68c46fa36651acf592771d09de7937926bb3
%make_install
