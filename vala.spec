...
Source0  : https://download.gnome.org/sources/vala/0.56/vala-0.56.14.tar.xz
...
%prep
%setup -q -n vala-0.56.14
cd %{_builddir}/vala-0.56.14
pushd ..
cp -a vala-0.56.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699903901
