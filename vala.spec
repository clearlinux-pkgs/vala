...
Source0  : https://download.gnome.org/sources/vala/0.56/vala-0.56.17.tar.xz
...
%prep
%setup -q -n vala-0.56.17
cd %{_builddir}/vala-0.56.17
pushd ..
cp -a vala-0.56.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713546611
