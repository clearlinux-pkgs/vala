...
Source0  : https://download.gnome.org/sources/vala/0.54/vala-0.54.6.tar.xz
...
%prep
%setup -q -n vala-0.54.6
cd %{_builddir}/vala-0.54.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641847326
...
cp %{_builddir}/vala-0.54.6/COPYING %{buildroot}/usr/share/package-licenses/vala/caeb68c46fa36651acf592771d09de7937926bb3
%make_install
